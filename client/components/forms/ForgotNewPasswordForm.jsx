    ...
    <>
      <form className="relative flex flex-col space-y-8">
        ...
        <div className="flex flex-col space-y-4">
          ...
          <button
            className="px-8 py-2 bg-gradient-to-br from-amber-500 to-purple-200 rounded-full hover:translate-y-1 duration-200 active:bg-slate-800"
      ...
      {ok && (
        <div className="absolute w-full h-full bg-black/40">
          <div className="absolute bg-white top-5 right-5 border border-black rounded flex flex-col p-4">
            ...
            <p className="text-black">Password Reset Succeded, you can login</p>
      ...
      {loading && (
        <div className="absolute bg-black/75 flex justify-center items-center w-full h-full">
          <div role="status">
            <svg
              aria-hidden="true"
